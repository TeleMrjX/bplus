...
json = (loadfile "./source/Management/helper/redisplus.lua")()
mimetype = (loadfile "./source/Management/helper/fakeredis_for_blackplus.lua")()
redis = (loadfile "./source/Management/helper/redis.lua")()
...
function download_to_file(url, file_name)
  ...
  local file_path = "/root/blackplus/source/dl/"..file_name
...
local bot_api = '249248482:AAGoAukjbuwzYCIo6kDQOti5aPtHNeTjl58'

function send_api_msg(msg, receiver, text, disable_web_page_preview, markdown)
  local url_api = 'https://api.telegram.org/bot'..bot_api..'/sendMessage?chat_id='..receiver..'&text='..URL.escape(text)
